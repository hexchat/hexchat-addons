...
# last change by pagu(at)plcnet(dot)org
...
# RPL_WHOISSPECIAL # pagu
on 320 mywhois {
  set whodata [split $_rest " "]
  set swhoisdata [lindex [split $_raw :] 2]
  print "[color 12]\[[color][lindex $whodata 0][color 12]\][color] $swhoisdata"
  complete EAT_ALL
}
...
puts "\[Plugin\]\t \[[color 4]Whois[color]\] [color 3]loaded[color]"
